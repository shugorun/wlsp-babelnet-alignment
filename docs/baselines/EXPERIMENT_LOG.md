...
This log records the reproducible baseline sequence under `src/baselines/`.

- Scope: `src/baselines/`
- Outputs: `outputs/baselines/`
- Note: `cross-encoder` outputs are kept in the repository, but they were not rerun in the current clean baseline sequence because the user explicitly deprioritized them.

## 2026-04-07 16:21:00 | gold_B_pairwise_baseline

- Script: `src/baselines/run_gold_b_baseline.py`
...
- Script: `src/baselines/run_gold_b_ranking.py`
...
- Script: `src/baselines/run_gold_b_hybrid_search.py`
...
- Outputs:
  ...
  - `outputs/baselines/gold_B_hybrid_best/pair_features_hybrid.pkl`
  - `outputs/baselines/gold_B_hybrid_best/oof_predictions.pkl`
  - `outputs/baselines/gold_B_hybrid_best/metrics.pkl`
  - `outputs/baselines/gold_B_hybrid_best/logreg_model.pkl`
  - `outputs/baselines/gold_B_hybrid_best/config.json`

## 2026-04-07 16:38:26 | gold_B_record_decoder

- Script: `src/baselines/run_gold_b_record_decoder.py`
...
- Params:
  - `input_hybrid_dir`: `outputs/baselines/gold_B_hybrid_best`
  - `n_splits`: `5`
  - `random_state`: `0`
...
- Script: `src/baselines/run_gold_a_hybrid_best.py`
...
- Params:
  - `source_gold_B_config`: `outputs\baselines\gold_B_hybrid_best\config.json`
  - `query_mode`: `natural`
...
- Outputs:
  ...
  - `outputs\baselines\gold_A_hybrid_best\pair_features.pkl`
  - `outputs\baselines\gold_A_hybrid_best\rankings.pkl`
...
- Script: `src/baselines/run_gold_a_no_training_methods.py`
...
- Outputs:
  - `outputs\baselines\gold_A_no_training_methods\weighted_rankings.pkl`
  - `outputs\baselines\gold_A_no_training_methods\e5_rankings.pkl`
  - `outputs\baselines\gold_A_no_training_methods\mpnet_rankings.pkl`
  - `outputs\baselines\gold_A_no_training_methods\cross_encoder_rankings.pkl`
